...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "API to manage Villas resort",
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "Magic-VillaV1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "Magic-VillaV2");
    });
}
