...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM model)
        {
            ...
            var dropdownList = await _villaService.GetAllAsync<APIResponse>(HttpContext.Session.GetString(StaticDetails.SessionToken));
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNum)
        {
            ...
            var response = await _villaNumberService.GetAsync<APIResponse>(villaNum, HttpContext.Session.GetString(StaticDetails.SessionToken));
            if (response != null && response.IsSuccess)
            {
        ...
        public async Task<IActionResult> DeleteVillaNumber(VillaNumberDeleteVM model)
        {
            ...
            var response = await _villaNumberService.DeleteAsync<APIResponse>(model.VillaNumber.VillaNum, HttpContext.Session.GetString(StaticDetails.SessionToken));
            if (response != null && response.IsSuccess)
            {
                return RedirectToAction(nameof(IndexVillaNumber));
            }
